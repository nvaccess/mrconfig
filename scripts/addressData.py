...
addresses = {
	...
	'bg': {
		...
		'email': [
			...
			'Kostadin Kolev <k_kolev1985@mail.com>',
		],
	},
	'ca': {
		'lang': 'Catalan',
	...
	'lv': {
		'lang': 'Latvian',
		'email': [
			'Verners Šteinbergs <verners_lnb@inbox.lv>',
		],
	},
	'mk': {
		'lang': 'Macedonian',
	...
	'th': {
		'lang': 'Thai',
		'email': [
			'Eakachai Charoenchaimonkon <eakachai@gmail.com>',
		],
	},
	'tr': {
		'lang': 'Turkish',
	...
	'ur': {
		'lang': 'Urdu',
		'email': [
			'Waqas Ramzan <waqas.techlover@gmail.com>',
		],
	},
	'vi': {
		'lang': 'Vietnamese',
